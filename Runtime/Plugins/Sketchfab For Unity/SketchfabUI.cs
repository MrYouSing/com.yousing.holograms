...
namespace Sketchfab
{
	public class SketchfabUI
	{
		...
		public GUIStyle getSketchfabModelName()
		{
			...
			{
				_sketchfabModelName = new GUIStyle(GUI.skin.label);
		...
		public GUIStyle getSketchfabMiniModelName()
		{
			...
			{
				_sketchfabMiniModelname = new GUIStyle(GUI.skin.label);
		...
		public GUIStyle getSketchfabMiniAuthorName()
		{
			...
			{
				_sketchfabMiniAuthorname = new GUIStyle(GUI.skin.label);
		...
		public GUIStyle getSketchfabContentLabel()
		{
			...
			{
				_sketchfabContentLabel = new GUIStyle(GUI.skin.label);
		...
		public GUIStyle getSketchfabTitleLabel()
		{
			...
			{
				_sketchfabTitleLabel = new GUIStyle(GUI.skin.label);
		...
		public GUIStyle getSketchfabClickableLabel()
		{
			...
			{
				_sketchfabClickableLabel = new GUIStyle(GUI.skin.label);
		...
		public GUIStyle getSketchfabLabel()
		{
			...
			{
				_sketchfabLabel = new GUIStyle(GUI.skin.label);
		...
		public GUIStyle getSketchfabBigLabel()
		{
			...
			{
				_sketchfabBigLabel = new GUIStyle(GUI.skin.label);
